...
// Create the CreateCourse Component
export default class CreateCourse extends Component {
  ...
  // Check if user is Authorized to create a course, then creates it
  submit = () => {
    const { context } = this.props;
  ...
  //Redirect user to the Courses page when the cancel button in clicked.
